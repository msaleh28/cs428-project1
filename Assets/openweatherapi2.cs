...
public class openweatherapi2 : MonoBehaviour
{
    public GameObject weatherTextObject;
        // add your personal API key after APPID= and before &units=
       string url = "http://api.openweathermap.org/data/2.5/weather?lat=29.97&lon=31.13&APPID=08967d9008cebc61d9646557942f2d1f&units=metric";
